...
string Cmp_mult_op_s::GetVHDLDeclaration(string nameExtension) {
	string decl = "";
...
void Cmp_mult_op_s::CreateGenericMaps() {
    AddGenericMap(new GenericMap("w_in1", "integer", "8"));
    MapStrings["w_in1"] = 0;
    AddGenericMap(new GenericMap("w_in2", "integer", "8"));
    MapStrings["w_in2"] = 1;
    AddGenericMap(new GenericMap("w_out", "integer", "16"));
    MapStrings["w_out"] = 2;
}
