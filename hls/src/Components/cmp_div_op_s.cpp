...
Cmp_div_op_s::Cmp_div_op_s(int dataWidth) : Component() {
    SetComponentName("div_op_s");
...
string Cmp_div_op_s::GetVHDLDeclaration(string nameExtension){
    string decl = "";
...
void Cmp_div_op_s::CreateGenericMaps() {
